	...
	<section class="student input">
		<form method="post">
    		...
    		<div><label for="st_dept">학과</label>
    			<input type="text" id="st_dept" name="st_dept" value="${ST.st_dept }"></div>
    		<div><label for="st_grade">학년</label>
    			<input type="text" id="st_grade" name="st_grade" value="${ST.st_grade }"></div>
    		<div><label for="st_tel">전화번호</label>
    			<input type="text" id="st_tel" name="st_tel" value="${ST.st_tel }"></div>
    		<div><label for="st_addr">주소</label>
    			<input type="text" id="st_addr" name="st_addr" value="${ST.st_addr }"></div>
