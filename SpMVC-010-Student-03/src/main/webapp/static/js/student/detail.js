document.addEventListener("DOMContentLoaded", () => {
  ...
  // event handler를 익명(무명) 함수로 선언하기
  // 외부에 함수를 선언하지 않고 직접 선언한 함수 몸체를 handler에 add(추가하기)
  // 함수를 한번만 사용하고 다른 곳에서는 더이상 사용하지 않을 것이다 라는 예측으로 제작
  // 익명함수로 handler를 선언하는 것을 Call Back 함수 선언이라고도 한다
